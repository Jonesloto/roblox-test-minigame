...
--- self:signal_server(action_string)
--- self:retrieve_from_server(action_string) -- returns a value
--- self:register_event(action, func)
--- self:create_instance(inst_name, parent, properties_table) -- returns a value
...
local SampleController = {}

function SampleController:start()
